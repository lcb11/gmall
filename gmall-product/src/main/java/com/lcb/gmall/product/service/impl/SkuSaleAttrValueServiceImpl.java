...
import com.lcb.gmall.product.service.SkuSaleAttrValueService;
...
public class SkuSaleAttrValueServiceImpl extends ServiceImpl<SkuSaleAttrValueDao, SkuSaleAttrValueEntity> implements SkuSaleAttrValueService {
    ...
    @Override
    public List<String> getSkuSkuSaleAttrValuesAsStringList(Long skuId) {
        SkuSaleAttrValueDao dao = this.baseMapper;

        return dao.getSkuSkuSaleAttrValuesAsStringList(skuId);
    }
